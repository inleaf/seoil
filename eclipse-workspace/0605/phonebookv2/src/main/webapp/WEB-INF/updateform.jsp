...
<h3 class="text-center mt-3">전화번호부 수정</h3>
<div class="mb-3">
...
<input class="form-control btn bg-primary text-white mb-3" type="submit" value="수정하기">
<input class="form-control btn bg-primary text-white mb-3" type="button" value="취소하기"
